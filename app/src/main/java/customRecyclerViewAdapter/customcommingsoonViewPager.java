...
/**
 * Created by shituocheng on 16/6/3.
 */

public class customcommingsoonViewPager extends RecyclerView.Adapter<customcommingsoonViewPager.ViewHolder> {
    ...
    public customcommingsoonViewPager(List<MovieModel> movieModels) {
