...
/**
 * Created by shituocheng on 16/6/7.
 */

public class Top250RecyclerViewAdapter extends RecyclerView.Adapter<Top250RecyclerViewAdapter.ViewHolder> {
    ...
    public Top250RecyclerViewAdapter(List<MovieModel> movieModels) {
