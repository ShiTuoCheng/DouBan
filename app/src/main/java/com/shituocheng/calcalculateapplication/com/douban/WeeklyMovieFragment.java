 ...
 */
public class WeeklyMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_weekly_movie, container, false);
    ...
    public void fetchData(){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    mConnection = (HttpURLConnection)new URL(API.NEW_MOVIE_API).openConnection();
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mRecyclerView = (RecyclerView)getActivity().findViewById(R.id.weekly_recylcerView);

                            WeeklyRecyclerViewAdapter customRecyclerViewAdapter = new WeeklyRecyclerViewAdapter(mMovieModels);
                            ...
                            customRecyclerViewAdapter.setOnItemClickListener(new WeeklyRecyclerViewAdapter.ClickListener() {
                                @Override
