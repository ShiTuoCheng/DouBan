...
import customRecyclerViewAdapter.Top250RecyclerViewAdapter;
 ...
 */
public class Top250MovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_top250_movie, container, false);
    ...
    public void fetchData(){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    mConnection = (HttpURLConnection)new URL(API.TOP250_MOVIE_API).openConnection();
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mRecyclerView = (RecyclerView)getActivity().findViewById(R.id.top250_recylcerView);

                            Top250RecyclerViewAdapter customRecyclerViewAdapter = new Top250RecyclerViewAdapter(mMovieModels);
                            ...
                            customRecyclerViewAdapter.setOnItemClickListener(new Top250RecyclerViewAdapter.ClickListener() {
                                @Override
